...
) void
{
    ...
    {
        if (
            lbrace_loc_column + (rbrace_start - lbrace_start)
            <= MAX_LINE_LENGTH
        )
        {
            return;
...
fn example_not_equal(
    very_long_variable_name_alpha: usize,
    very_long_variable_name_beta: usize,
) void
{
