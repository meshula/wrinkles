...
test "samples_between_time" 
{
    ...
    const sine_samples = try sine_signal_48khz.rasterized(std.testing.allocator);
    ...
    try expectEqual(
        sine_signal_48khz.sampling_rate_hz/2,
...
test "resample from 48khz to 44" 
{
    ...
    const sine_samples_48khz_100 = (
        try sine_signal_48kz_100.rasterized(std.testing.allocator)
    );
    defer sine_samples_48khz_100.deinit();
